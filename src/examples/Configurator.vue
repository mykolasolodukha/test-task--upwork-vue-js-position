  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card" :class="darkMode ? '' : 'blur'">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <!-- Navbar Fixed -->
        <div
          class="d-flex align-items-centerd-flex align-items-center mt-3 justify-content-between"
        >
          <div class="mt-3">
...
export default {
  ...
  computed: {
    ...
    isDarkMode: {
      ...
      set(val) {
        this.$store.dispatch("setDarkMode", val);
      },
    },
    isNavbarFixed: {
      get() {
    ...
    isSidebarPinned: {
      get() {
        return !this.sidebarPinned;
      },
      set(val) {
        this.$store.dispatch("setSidebarPinned", !val);
      },
    },
    show: {
      get() {
      ...
      set(val) {
        this.$store.dispatch("setShowConfigurator", val);
      },
    },
  },
};
